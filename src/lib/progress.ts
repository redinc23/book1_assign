 ...
 * zero (e.g. a book with no target word count, or an empty task list), and
 * when either argument is not a finite number — `NaN`, `Infinity`, `null`, or
 * `undefined` can all reach here at runtime despite the numeric types. The
